...
class StrategyTest(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions = []
        conditions.append(
            qtpylib.crossed_below(dataframe[f'rsi_4h'], 70)
        )
        conditions.append(
        ...
        conditions = []
        conditions.append(
            qtpylib.crossed_above(dataframe[f'rsi_4h'], 30)
        )
        conditions.append(
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[(dataframe[f'rsi_4h'] > 70),'exit_long'] = 1

        dataframe.loc[(dataframe[f'rsi_4h'] < 30),'exit_short'] = 1
