...
class AtlasEngine(IStrategy):
    ...
    buy_long_pt = DecimalParameter(low=0.01, high=0.9,default=0.5, decimals=2, optimize=True, load=True)
    buy_long_tt = IntParameter(low=1, high=10, default=2, optimize=True, load=True)

    buy_short_pt = DecimalParameter(low=0.01, high=0.9,default=0.5, decimals=2, optimize=True, load=True)
    buy_short_tt = IntParameter(low=1, high=10, default=2, optimize=True, load=True)

    sell_long_pt = DecimalParameter(low=0.01, high=0.9,default=0.5, decimals=2, optimize=True, load=True)
    sell_long_tt = IntParameter(low=1, high=10, default=2, optimize=True, load=True)

    sell_short_pt = DecimalParameter(low=0.01, high=0.9,default=0.5, decimals=2, optimize=True, load=True)
